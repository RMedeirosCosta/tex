...
Utilizou-se o \emph{using periodic commit 600} para evitar problemas referentes a gerenciamento da memória, conforme sugere a documentação oficial do \emph{Neo4j}. O número 600 é a quantidade de registros por \textif{commit}.
...
Foi adicionado nessa consulta a cláusula limit 400, para ser exibido apenas 400 resultados para facilitar a visualização.
